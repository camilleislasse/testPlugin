...
namespace Acme\SyliusExamplePlugin\Component\Core\Taxation\Applicator;

use Acme\SyliusExamplePlugin\Component\Taxation\Resolver\TaxRateResolverInterface;
...
class OrderItemUnitsTaxesApplicator implements OrderTaxesApplicatorInterface
{
    ...
    public function apply(OrderInterface $order, ZoneInterface $zone): void
    {
        ...
        foreach ($order->getItems() as $item) {
            ...
            $taxRate = $this->taxRateResolver->resolve($item->getVariant(), ['zone' => $zone], $order);
            if (null === $taxRate) {
                continue;
            }
